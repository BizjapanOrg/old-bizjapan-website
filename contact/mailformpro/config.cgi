...
## フォームの送信先
push @mailto,'info@bizjapan.org';

## 自動返信メールの差出人名
$config{'fromname'} = 'NPO Bizjapan';
...
$config{'ThanksPage'} = 'https://bizjapan.org/';
...
$config{"ReturnSubject"} = 'Hi from Bizjapan Team!';

## 自動返信メールの本文
$_TEXT{'responder'} = <<'__return_body__';
Thank you for reaching out us!
Bizjapan members will check your message soon!

この度はお問い合せ頂き誠にありがとうございました。
数日中に改めて担当者よりご連絡をさせていただきます。

─Confirmation─────────────────
<_resbody_>
──────────────────────────

If you have no idea about this email, please contact us from the following email address.
Thank you so much!
