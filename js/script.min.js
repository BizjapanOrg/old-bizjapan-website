$("head").append('<style type="text/css">.is-hide{display:none;}</style>'), $(window).on("load", function() {
  $("body").fadeIn(500).removeClass("is-hide")
}), $(function() {
  $("a.fadelink").on("click", function() {
    var o = $(this).attr("href");
    return "" != o && ($("body").fadeOut(500), setTimeout(function() {
      location.href = o
    }, 500)), !1
  })
  ...
  $(".title-effect").css("opacity", "0"), $(".vision").css("opacity", "0"), $(".project-example").css("opacity", "0"), $(window).scroll(function() {
    $(".title-effect").each(function() {
      var o = $(this).offset().top,
        c = $(window).scrollTop(),
        n = $(window).height();
      c > o - n + 100 && $(this).animate({
        opacity: "1"
      }, 1e3)
  ...
  }), $(".project-modal-wrapper").click(function(o) {
    $(o.target).closest(".modal").length || $(".project-modal-wrapper").fadeOut()
  }), $(".toggle").click(function() {
    $(this).toggleClass("active"), $(this).hasClass("active") ? ($(".nav-wrapper").fadeIn(), $("body,html").css({
      overflow: "hidden",
      height: "100%"
    })) : ($(".nav-wrapper").fadeOut(), $("body,html").css({
      overflow: "visible",
      height: "auto"
    }))
  })
...
$win.on("load scroll", function() {
  ...
  o > startPos && o > headerHeight ? $header.css("top", "-" + headerHeight + "px") : $header.css("top", "0"), startPos = o
